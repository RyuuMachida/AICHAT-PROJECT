    ...
    <div className="app-layout">
      ...
      <div className="main-content">
        ...
        <div className="mobile-topbar">
          ...
          {/* Center: title atau logo */}
          <div style={{ flex: 1, minWidth: 0, overflow: "hidden" }}>
            {view === "settings" ? (
              <span className="mobile-topbar-title">Pengaturan</span>
            ) : inConversation ? (
              <span className="mobile-topbar-title" style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", display: "block" }}>
          ...
          {/* Right: model selector hanya saat conversation */}
          {inConversation && (
